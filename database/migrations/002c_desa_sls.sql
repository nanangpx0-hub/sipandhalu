-- SIPANDHALU tahap 2a (revisi): tanpa FULLTEXT di desa agar FK 1215 hilang di MySQL 8.0.30
USE sipandhalu;

CREATE TABLE IF NOT EXISTS desa (
  id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  kecamatan_kode CHAR(3) NOT NULL,
  ...
  CONSTRAINT fk_desa_kec FOREIGN KEY (kecamatan_kode) REFERENCES kecamatan (kode)
